...
SELECT
    ...
    sensor,
    based_on_x_messages,
    avg((detail_elems ->> 'count')::numeric) FILTER (WHERE detail_elems ->> 'direction' = 'up') AS passanten_up_avg,
    avg((detail_elems ->> 'count')::numeric) FILTER (WHERE detail_elems ->> 'direction' = 'down') AS passanten_down_avg,
