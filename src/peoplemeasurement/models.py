...
class Sensors(models.Model):
    gid = models.IntegerField(
        unique=True
    )  # Used for reference in external applications
    ...
    is_active = models.BooleanField(
        default=True
    )  # Can be used by the dashboard to display or hide sensors
    is_public = models.BooleanField(
        default=True
    )  # Defines whether the record can be displayed in publications
...
class Area(models.Model):
    sensor = models.ForeignKey(
        "Sensors", related_name="areas", on_delete=models.CASCADE
    )
...
class Line(models.Model):
    sensor = models.ForeignKey(
        "Sensors", related_name="lines", on_delete=models.CASCADE
    )
