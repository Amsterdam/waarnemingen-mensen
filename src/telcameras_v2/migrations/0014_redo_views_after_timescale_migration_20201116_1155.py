...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql=f"ALTER SEQUENCE telcameras_v2_countaggregate_id_seq OWNED BY telcameras_v2_countaggregate.id;"
        ),
        migrations.RunSQL(
            sql=f"ALTER SEQUENCE telcameras_v2_personaggregate_id_seq OWNED BY telcameras_v2_personaggregate.id;"
        ),
        migrations.RunSQL(
            sql=f"ALTER SEQUENCE telcameras_v2_observation_id_seq OWNED BY telcameras_v2_observation.id;"
        ),
    ]
    ...
    for view in VIEWS:
        ...
        operations.append(
            migrations.RunSQL(
                sql=view_strings["sql"], reverse_sql=view_strings["reverse_sql"]
            )
        )
