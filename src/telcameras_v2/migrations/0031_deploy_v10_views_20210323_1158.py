...
class Migration(migrations.Migration):
    ...
    _PREDICT_VIEW_NAME = "cmsa_predict_view_v10"
    _predict_view_strings = get_view_strings(_PREDICT_VIEW_NAME)

    _REALTIME_VIEW_NAME = "cmsa_15min_view_v10_realtime_predict"
    _realtime_view_strings = get_view_strings(_REALTIME_VIEW_NAME)

    _REALTIME_30D_VIEW_NAME = "cmsa_15min_view_v10_realtime_predict_30d"
