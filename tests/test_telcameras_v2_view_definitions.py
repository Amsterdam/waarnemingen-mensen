...
class TestViewDefinitions:
    def test_get_view_strings(self):
        ...
        view_strings = get_view_strings(
            MOCK_VIEW_STRINGS, mock_view_name, indexes=indexes
        )
